...
permalink: /posts/tableau-dashboard-collection/
categories: [Blogging, Portofolio]
tags: [Data Science, Blog]
author: abelkrw
image:
  path: /assets/img/additional/cia.png
  alt: Preview of Abel Kristanto Widodo's Tableau dashboard collection
---

This collection highlights Abel's public Tableau dashboards. Each project is designed to turn a large dataset into a visual story that is easier to understand, compare, and act on.

## Car Insurance Analysis

This dashboard helps explain insurance claim patterns across customer demographics and vehicle-related factors. It was built to make it easier to identify trends, compare groups, and support better interpretation of claim behavior.
...
This dashboard examines song popularity and engagement in the streaming era. It helps users explore artist performance, platform exposure, and musical characteristics that influence visibility and listener interest.
...
This dashboard focuses on hotel booking patterns and guest behavior. It helps explain how reservation channels, guest demographics, hotel types, and booking outcomes interact in the hospitality industry.
